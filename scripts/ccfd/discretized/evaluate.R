...
test <- read.csv(file = "./data/ccfd/discretized/test.csv", header = TRUE, sep = ",", row.names = NULL)
model <- load_model_hdf5("./models/ccfd/discretized/3_layers/20181117T1407.hdf5")

X_test <- as.matrix(test[1:240])
y_test <- as.matrix(test[241])
