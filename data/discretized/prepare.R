...
write.csv(train_discretized, file = "./data/discretized/train.csv", row.names = FALSE)
write.csv(test_discretized, file = "./data/discretized/test.csv", row.names = FALSE)
